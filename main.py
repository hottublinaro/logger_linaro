...
while True:
    try:
        ...
        if machine_code != '':
            ...
            plc_out_read = open('/home/linaro/txt_file/status_plc.txt','r')
            ...
            # plc in
            plc_in_read = open('/home/linaro/txt_file/status_plc_in.txt','r')
            ...
            # relay
            relay_read = open('/home/linaro/txt_file/status_relay_8.txt','r')
            ...
            # ph
            read_ph = open('/home/linaro/txt_file/ph.txt','r')
            ph_data = read_ph.read()
            # orp
            read_orp = open('/home/linaro/txt_file/orp.txt','r')
            orp_data = read_orp.read()
            # temp
            read_temp = open('/home/linaro/txt_file/temperature.txt','r')
            temp_data = read_temp.read()
            #pressure
            read_pressure = open('/home/linaro/txt_file/pressure.txt','r')
